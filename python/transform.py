...
df = df[0].rename(columns={"Year": "reportCardStartYear","____LEA Name____" : "agency", "INDIAN Male" : "pupilsIndianMale", "INDIAN Female" : "pupilsIndianFemale", "ASIAN Male" : "pupilsAsianMale", "ASIAN Female" : "pupilsAsianFemale", "HISPANIC Male" : "pupilsHispanicMale", "HISPANIC Female" : "pupilsHispanicFemale", "BLACK Male" : "pupilsBlackMale", "BLACK Female" : "pupilsBlackFemale", "WHITE Male" : "pupilsWhiteMale", "WHITE Female" : "pupilsWhiteFemale", "PACIFIC ISLAND\u00a0 Male" : "pupilsPacificIslanderMale", "PACIFIC ISLAND Male" : "pupilsPacificIslanderMale", "PACIFIC ISLAND\u00a0 Female" : "pupilsPacificIslanderFemale", "PACIFIC ISLAND Female" : "pupilsPacificIslanderFemale", "TWO OR MORE Male" : "pupilsMultiRacialMale", "TWO OR MOREFemale" : "pupilsMultiRacialFemale"})
df.insert(1, "pk", df["reportCardStartYear"]+df["LEA"] )
df.insert(1, "agencyKey", df["LEA"] )
