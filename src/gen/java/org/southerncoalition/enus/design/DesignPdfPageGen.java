...
public abstract class DesignPdfPageGen<DEV> extends DesignPdfGenPage {
	 ...
	 *  is defined as null before being initialized. 
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.southerncoalition.enus.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:reportCardCounties_">Find the entity reportCardCounties_ in Solr</a>
	 * <br/>
	 * @param c is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public DesignPdfPage addReportCardCounties_(ReportCard...objets) {
		for(ReportCard o : objets) {
			addReportCardCounties_(o);
		}
		return (DesignPdfPage)this;
	}
	public DesignPdfPage addReportCardCounties_(ReportCard o) {
		if(o != null && !reportCardCounties_.contains(o))
			this.reportCardCounties_.add(o);
		return (DesignPdfPage)this;
	}
	protected DesignPdfPage reportCardCounties_Init() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.southerncoalition.enus.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:reportCardCounty_">Find the entity reportCardCounty_ in Solr</a>
	 * <br/>
	 * @param c is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected DesignPdfPage reportCardCounty_Init() {
	 ...
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.southerncoalition.enus.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:countySearch">Find the entity countySearch in Solr</a>
	 * <br/>
	...
	protected DesignPdfPage countySearchInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.southerncoalition.enus.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:county_">Find the entity county_ in Solr</a>
	 * <br/>
	 * @param c is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected DesignPdfPage county_Init() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.southerncoalition.enus.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:countyKey">Find the entity countyKey in Solr</a>
	 * <br/>
	 * @param c is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public DesignPdfPage setCountyKey(String o) {
		if(NumberUtils.isParsable(o))
			this.countyKey = Long.parseLong(o);
		this.countyKeyWrap.alreadyInitialized = true;
		return (DesignPdfPage)this;
	}
	protected DesignPdfPage countyKeyInit() {
	...
	public Object obtainDesignPdfPage(String var) {
		...
		switch(var) {
			...
			case "reportCardCounties_":
				return oDesignPdfPage.reportCardCounties_;
			case "reportCardState_":
				return oDesignPdfPage.reportCardState_;
			case "reportCardCounty_":
				return oDesignPdfPage.reportCardCounty_;
			case "reportCardReportCard_":
				return oDesignPdfPage.reportCardReportCard_;
			case "countySearch":
				return oDesignPdfPage.countySearch;
			case "county_":
				return oDesignPdfPage.county_;
			case "countyKey":
				return oDesignPdfPage.countyKey;
			case "stateSearch":
