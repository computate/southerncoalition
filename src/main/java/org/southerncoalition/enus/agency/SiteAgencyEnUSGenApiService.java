...
public interface SiteAgencyEnUSGenApiService {
	static void registerService(SiteContextEnUS siteContext, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("southerncoalition-enUS-SiteAgency").register(SiteAgencyEnUSGenApiService.class, new SiteAgencyEnUSApiServiceImpl(siteContext));
	}
