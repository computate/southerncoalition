...
public interface PageDesignEnUSGenApiService {
	static void registerService(SiteContextEnUS siteContext, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("southerncoalition-enUS-PageDesign").register(PageDesignEnUSGenApiService.class, new PageDesignEnUSApiServiceImpl(siteContext));
	}
